# AUTOGENERATED! DO NOT EDIT! File to edit: ../../notebooks/06-density-db-finalising.ipynb.

# %% auto 0
__all__ = ['get_gram_weight', 'get_weight_ratio']

# %% ../../notebooks/06-density-db-finalising.ipynb 4
import pandas as pd
import numpy as np

import json

# %% ../../notebooks/06-density-db-finalising.ipynb 10
with open('../data/globals/unit_conversions.json') as f:
    unit_list = json.load(f)

# %% ../../notebooks/06-density-db-finalising.ipynb 15
...
# %% ../../notebooks/06-density-db-finalising.ipynb 27
