# AUTOGENERATED! DO NOT EDIT! File to edit: ../../notebooks/05-density-db-portion-join.ipynb.

# %% auto 0
__all__ = ['root', 'select_food_portion']

# %% ../../notebooks/05-density-db-portion-join.ipynb 7
from pyprojroot import here
root = here()
import sys
sys.path.append(str(root))

# %% ../../notebooks/05-density-db-portion-join.ipynb 8
import pandas as pd
import numpy as np
...
# %% ../../notebooks/05-density-db-portion-join.ipynb 13
with open(f'{root}/data/globals/unit_conversions.json') as f:
    unit_list = json.load(f)

# %% ../../notebooks/05-density-db-portion-join.ipynb 18
